...
from .views import ProcessOrderView, OrderDetailsByOrderId, AddOrUpdateOrderDetails, DeleteOrderDetails, FinalizeOrderView, OrderListView
...
urlpatterns = [
    ...
    path('finalize-order/', FinalizeOrderView.as_view(), name='finalize-order'),
    path('getOrders/', OrderListView.as_view(), name='order-list'),
